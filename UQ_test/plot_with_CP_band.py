...
def get_all_raw_signals():
    ...
    #### Baselines
    # DER_metric = []; # training failed - NaN loss problem
    # STAC_metric = []; # rollout is too slow 
    ...
    baselines = [# STAC_metric, 
                 PCA_kmeans_metric, logpO_metric, logpZO_metric, 
                 # DER_metric, 
                 NatPN_metric, CFM_metric, RND_metric]                 
